...
const HAND_PATHS = {
  ...
  C: (
    ...
    <g>
      <path
        d="M42 18 Q20 18 20 32 Q20 46 42 46"
        fill="none"
        stroke="currentColor"
        strokeWidth="3"
        strokeLinecap="round"
      />
      <path
        d="M44 14 Q14 14 14 32 Q14 50 44 50"
        fill="none"
        stroke="currentColor"
        strokeWidth="2.5"
        strokeLinecap="round"
  ...
  D: (
    ...
    <g>
      ...
      />
      <path
        d="M33 22 Q45 20 45 32 Q45 44 33 44 L22 44 L22 30 Q22 20 33 22"
        fill="none"
        stroke="currentColor"
        strokeWidth="2.5"
      />
...
export default function FloatingHandSigns() {
  return (
    <div className="relative w-full py-12 md:py-20 pointer-events-none">
      <div
